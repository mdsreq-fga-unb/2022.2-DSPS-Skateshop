...
|                         | FEA04 - Usuários                  | US17 - Eu, como cliente da loja, preciso ter a opção de editar meus dados para não ter dados errados nem dados desatualizados na minha conta.                                                                                                                                                                                                           | Exceto CPF e data de nascimento, qualquer dado pode ser alterado separadamente; O CPF e a data de nascimento devem ser imutáveis; A alteração de email ou telefone celular deve ser confirmado pelo email previamente cadastrado; Em caso de alteração de email, o email novo deve ser confirmado por meio de um email; Em caso de alteração de telefone celular, o número novo deve ser confirmado por meio de SMS.            |
...
|                         |                                   | US19 - Eu, como cliente da loja, preciso realizar o cadastro para poder comprar na loja.                                                                                                                                                                                                                                      | Todos os campos devem ser preenchidos, respeitando o tipo de dado definido; Não podem ser registrados mais de um usuário com o mesmo email.                   |
